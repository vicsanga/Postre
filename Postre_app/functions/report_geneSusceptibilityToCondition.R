...
report_geneSusceptibilityToCondition<-function(reportUnit, patientResults){
  ...
  if((pathoMechanism=="LOF") && (targetPhase!="phaseFree")){
    ...
    textExplanation<-paste(textExplanation,
                           ...
                           "In addition, it is important to know the dosage sensitivity for the target gene. Because, deviations from the normal dosage (i.e. number of copies), or expression levels, can be pathogenic for some but not all genes. Haploinsufficiency (HI) and Triplosensitivity (TS) metrics are currently used as proxy for this aim. Briefly, HI scores are considered for Loss of Function and TS scores for Gain of Function. ",
