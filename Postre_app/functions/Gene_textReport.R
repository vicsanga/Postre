...
gene_textReport<-function(patientResults, minPatogenicScore, mainPhenotype, targetGene){
  ...
  for (gene in genesToWriteReport) {
    ...
    info_humanLogo<-"<div class='logoHuman_location'><img class='genePhenoImgs' src='human_silhouette_redimensionada.png' alt='human logo' id='HumanLogo'></div>"
    info_miceLogo<-"<div class='logoMice_location'><img class='genePhenoImgs' src='mouse_silhouette_blue-01.png' alt='mice logo' id='MiceLogo'></div>"
