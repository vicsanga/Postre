...
error_Report<-function(patientResults){
  ...
  <p style='font-size:25px' align='justify'>Please, check if the data introduced is correct and visit the User Guide if you have any doubt. If the problem persists contact us through sv_radalab@gmail.com to provide you more information about the particularities of this case.
  </div>
  </body>
  </html>"
